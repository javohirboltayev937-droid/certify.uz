    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-green-700 to-emerald-900 text-white py-14 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl font-extrabold mb-2 flex items-center gap-3">
            <BookOpenIcon className="w-10 h-10" /> CEFR Daraja Tizimi
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          {LEVELS.map(l => (
            <div key={l.level} className={`card p-5 border ${l.color}`}>
              ...
              <ul className="space-y-1">
                {l.examples.map(e => (
                  <li key={e} className="text-xs text-gray-500 flex items-center gap-1">
                    <CheckCircleIcon className="w-3.5 h-3.5 text-green-500 shrink-0" /> {e}
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/courses?subject=english" className="btn-primary inline-flex">
