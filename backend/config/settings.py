...
if config('USE_SQLITE', default=False, cast=bool):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='certify_db'),
            'USER': config('DB_USER', default='certify_user'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Certify.uz <info@certify.uz>')
...
# Test rejimi: https://test.paycom.uz  | Prod: https://checkout.paycom.uz
...
ESKIZ_SENDER = config('ESKIZ_SENDER', default='4546')  # Eskiz dan olinadigan sender ID
